...
from uni.dll import LinkedList

class DataLoader:
    """
    Utility class for loading data from the spreadsheet and creating connections
    using the the uni provided data types
    """
    @staticmethod
    def load_connections(file: str) -> LinkedList:
        """
...
if __name__ == "__main__":
    ...
    connections: LinkedList = DataLoader.load_connections("../data/London Underground data.xlsx")
